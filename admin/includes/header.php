...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Mukama</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="assets/profile/<?php echo $admin['pic'];?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          ...
          <!-- //banners -->
           <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="view_banner.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Banners</p>
                </a>
              </li>
           ...
           <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
             ...
             <!--  <li class="nav-item">
                <a href="edit_pro.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Edit Product</p>
                </a>
              </li> -->
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="pages/forms/general.html" class="nav-link">
                  <i class="far fa-account nav-icon"></i>
                  <p>Make Order</p>
                </a>
              </li>
              <li class="nav-item">
