...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Gama Sugarcane Jaggery</title>
    <!-- SEO Meta Tags-->
      ...
      <header class="shadow-sm">
        ...
        <div class="topbar topbar-dark bg-dark">
          <div class="container">
            ...
            <div class="ms-3 text-nowrap"><a class="topbar-link me-4 d-none d-md-inline-block" href="ordertracking.php"><i class="ci-location"></i>Order tracking</a>
            ...
            <div class="container">
              <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item active"><a class="nav-link dropdown-toggle" href="index.php">Home</a></li>
                  <li class="nav-item "><a class="nav-link dropdown-toggle" href="shop-grid-left.php">Shop</a></li>
                  ...
                  <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">Account</a>
                    <ul class="dropdown-menu">
                      <li class="dropdown"><a class="dropdown-item dropdown-toggle" href="#" data-bs-toggle="dropdown">User Account</a>
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="orders.php">Orders History</a></li>
                          <li><a class="dropdown-item" href="profile.php">Profile Settings</a></li>
                          <li><a class="dropdown-item" href="address.php">Account Addresses</a></li>
                          <li><a class="dropdown-item" href="payment.php">Payment Methods</a></li>
                          <li><a class="dropdown-item" href="whishlist.php">Wishlist</a></li>
                          <li><a class="dropdown-item" href="myticket.php">My Tickets</a></li>
                          <!-- <li><a class="dropdown-item" href="account-single-ticket.html">Single Ticket</a></li> -->
                        </ul>
                      </li>
                    
                      <li><a class="dropdown-item" href="signin.php">Sign In / Sign Up</a></li>
                      <li><a class="dropdown-item" href="forgot.php">Password Recovery</a></li>
                    </ul>
                  </li>

                    <li class="nav-item "><a class="nav-link dropdown-toggle" href="contact.php">Contact</a></li>
                        <li class="nav-item "><a class="nav-link dropdown-toggle" href="about.php">About us</a></li>

                       <li class="nav-item "><a class="nav-link dropdown-toggle" href="help.php">Help topics</a></li>
