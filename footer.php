 <footer class="footer bg-dark pt-5">
      ...
      <div class="pt-5 bg-darker">
        <div class="container">
          ...
          <div class="pb-4 fs-xs text-light opacity-50 text-center text-md-start">© All rights reserved. Made by <a class="text-light" href="../external.html?link=https://createx.studio/" target="_blank" rel="noopener">Mutale Jether</a></div>
        </div>
      </div>
    </footer>